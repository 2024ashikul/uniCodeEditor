...
export class AiService {
  ...
  async generateProblem(prompt: string): Promise<string> {
    const finalPrompt = `
  ...
  async generateLesson(prompt: string): Promise<string> {
    const finalPrompt = `
      Listen and Follow the instructions carefully:
  ...
  async generateCodeFeedback(prompt: string): Promise<string> {
    const finalPrompt = `
      Listen and Follow the instructions carefully:
